...
//
// Lanes are hit with A S K L (two-handed home row — bass rides the left lanes).
  ...
  function renderUi() {
    ...
    if (mode === 'select') {
      ...
      title.innerHTML =
        ...
        '<div style="font-size:12px;opacity:.7;margin-top:4px;letter-spacing:2px">CHARTS EXTRACTED FROM THE ACTUAL SONGS · HIT THE NOTES WITH A S K L</div>';
