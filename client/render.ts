...
const REPLAY_CAPTIONS = [
  ...
  ['RIP BOZO 🕊️',                  '#94a3b8'],
  ['CAUGHT IN 4K 📸',               '#38bdf8'],
  ['ABSOLUTE CINEMA 🎬',            '#c084fc'],
  ['BUILT DIFFERENT 💪',            '#4ade80'],
  ['SIR THIS IS A PONG GAME',       '#fbbf24'],
  ['CRYING AND SHAKING 😭',         '#fb7185'],
  ['GENERATIONAL TALENT',           '#fbbf24'],
  ['LOCKED IN 🔐',                  '#4ade80'],
  ['VICTIM 😭',                     '#f87171'],
  ['SEND IT TO ESPN',               '#38bdf8'],
  ['ZERO DIFF',                     '#94a3b8'],
  ["THEY SAID 'LET ME COOK' 🧑‍🍳", '#f97316'],
  ['SIGMA MOVE 😎',                 '#a78bfa'],
  ['FRAUDULENT 🕵️',                '#f43f5e'],
  ['DAWG 💀',                       '#f87171'],
  ['VILLAIN ARC 😈',                '#c084fc'],
  ['PONG IS A SPORT',               '#fbbf24'],
  ['MANIFESTED THAT W 🔮',          '#e879f9'],
  ['NO CAP 🧢',                     '#4ade80'],
  ['CHRONICALLY ONLINE BEHAVIOR',   '#a78bfa'],
  ['COOKED, SEASONED, SERVED 🍽️',  '#f97316'],
  ['GOATED WITH THE SAUCE 🧃',      '#4ade80'],
  ['POV: YOU LOST',                 '#f87171'],
  ['THEY NEVER MISS 🎯',            '#fbbf24'],
  ['MAIN CHARACTER WON',            '#c084fc'],
  ['GO HOME 🏠',                    '#f87171'],
  ["DIDN'T EVEN TRY 🥱",           '#94a3b8'],
  ['DELIGHTFULLY UNHINGED',         '#e879f9'],
  ['NEW WORLD RECORD 🌍',           '#38bdf8'],
  ['SIT DOWN 🪑',                   '#f43f5e'],
  ['COPE 😭',                       '#f87171'],
  ['FREE 💅',                       '#4ade80'],
  ['MID 😐',                        '#94a3b8'],
  ["BROTHER IN CHRIST 😭",          '#fb923c'],
];
