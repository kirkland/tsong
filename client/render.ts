...
// Base paddle half-height, used by the fatality animation (which always renders the
// loser at full height regardless of any active power-up).
...
export function draw(ctx: CanvasRenderingContext2D, s: StateMsg) {
  ...
  // the "longer paddle" power-up render correctly.
