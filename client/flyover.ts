...
const MESSAGES: { text: string; cls: string }[] = [
  ...
  { text: '✝ In the beginning was the Word — John 1:1', cls: 'fo-bible' },
  { text: '✝ The LORD is my light and my salvation — Psalm 27:1', cls: 'fo-bible' },
  { text: '✝ Rejoice in the Lord always — Philippians 4:4', cls: 'fo-bible' },
  { text: '✝ Now abide faith, hope, love; the greatest is love — 1 Corinthians 13:13', cls: 'fo-bible' },
  { text: '✝ Trust in the LORD with all thine heart — Proverbs 3:5', cls: 'fo-bible' },
  { text: '✝ Let your light so shine before men — Matthew 5:16', cls: 'fo-bible' },
  { text: '✝ Joy cometh in the morning — Psalm 30:5', cls: 'fo-bible' },
  { text: '✝ Cast all your anxiety on Him — 1 Peter 5:7', cls: 'fo-bible' },
  { text: '✝ The truth shall make you free — John 8:32', cls: 'fo-bible' },
  { text: '✝ Blessed are the peacemakers — Matthew 5:9', cls: 'fo-bible' },
  // Comradely
  ...
  { text: '☭ Paddles of all courts, unite!', cls: 'fo-red' },
  { text: '☭ The rally belongs to those who serve', cls: 'fo-red' },
  { text: '☭ Property is theft; the ball is communal', cls: 'fo-red' },
  { text: '☭ One does not simply own the means of spin', cls: 'fo-red' },
  { text: '☭ Solidarity forever, deflection never', cls: 'fo-red' },
  { text: '☭ Comrade, your win streak serves the collective', cls: 'fo-red' },
  { text: '☭ Abolish the bourgeois scoreboard', cls: 'fo-red' },
  { text: '☭ The dialectic of paddle and ball drives history', cls: 'fo-red' },
  { text: '☭ A spectre is haunting tsong — the spectre of teamwork', cls: 'fo-red' },
  { text: '☭ From each a serve, to each a volley', cls: 'fo-red' },
  // Irreverent
  ...
  { text: '😎 you miss 100% of the balls you don\'t return', cls: 'fo-fun' },
  { text: '🧃 hydrate or diedrate, champ', cls: 'fo-fun' },
  { text: '🛒 buy our DLC: the second paddle', cls: 'fo-fun' },
  { text: '🐌 your reaction time? geological.', cls: 'fo-fun' },
  { text: '🎰 the house always wins (the house is the ball)', cls: 'fo-fun' },
  { text: '📉 your elo called, it wants a word', cls: 'fo-fun' },
  { text: '🤡 honk if you whiffed that serve', cls: 'fo-fun' },
  { text: '🛟 reminder: the ball comes back. plan accordingly.', cls: 'fo-fun' },
  { text: '🦖 extinction-level whiff incoming', cls: 'fo-fun' },
  { text: '👽 we have observed your gameplay. we are concerned.', cls: 'fo-fun' },
];
