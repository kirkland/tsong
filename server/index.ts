...
initDb()
  .then(() => Promise.all([lobby.refreshLeaderboard(), lobby.refreshDoomLeaderboards(), lobby.refreshCampaignLeaderboards(), lobby.refreshGhLeaderboard(), lobby.loadStockPrices(), lobby.loadModes(), lobby.loadNomicState()]))
    ...
    switch (msg?.type) {
      ...
      case 'mode':
        lobby.setMode(ws, {
          ...
          typeRacer: typeof msg.typeRacer === 'boolean' ? msg.typeRacer : undefined,
        });
        break;
      case 'fatality':
      ...
      case 'srStart':
        ...
        break;
      case 'srEnd':
        if (typeof msg.winner === 'number') lobby.srEnd(ws, msg.winner);
        break;
      case 'srRelay':
      ...
      case 'trnStart':
        ...
        break;
      case 'trnEnd':
        if (typeof msg.winner === 'number') lobby.trnEnd(ws, msg.winner);
        break;
      case 'trnRelay':
        if (msg.data !== undefined) lobby.trnRelay(ws, msg.data);
        break;
      case 'ghScore':
        if (typeof msg.song === 'string' && typeof msg.diff === 'string' && typeof msg.score === 'number') {
      ...
      case 'mjStart':
        ...
        break;
      case 'mjEnd':
        if (typeof msg.winner === 'number') lobby.mjEnd(ws, msg.winner);
        break;
      case 'mjRelay':
        if (msg.data !== undefined) lobby.mjRelay(ws, msg.data);
        break;
      case 'tdJoin':
        lobby.tdJoin(ws);
        break;
