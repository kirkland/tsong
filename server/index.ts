  ...
  ws.on('message', (raw) => {
    ...
    switch (msg?.type) {
      ...
      case 'shopBuy':
        ...
        break;
      case 'shopEquip':
        if ((msg.slot === 'hat' || msg.slot === 'skin' || msg.slot === 'trail' || msg.slot === 'title' || msg.slot === 'song' || msg.slot === 'car' || msg.slot === 'boat' || msg.slot === 'pet') && (msg.item === null || typeof msg.item === 'string')) {
